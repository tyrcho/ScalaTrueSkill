// Generated by delombok at Mon Sep 05 01:05:24 CEST 2011
...
public class GaussianDistribution {
	...
	public boolean equals(final java.lang.Object o) {
		...
		if (java.lang.Double.compare(this.mean, other.mean) != 0) return false;
		if (java.lang.Double.compare(this.standardDeviation, other.standardDeviation) != 0) return false;
		if (java.lang.Double.compare(this.variance, other.variance) != 0) return false;
		if (java.lang.Double.compare(this.precision, other.precision) != 0) return false;
		if (java.lang.Double.compare(this.precisionMean, other.precisionMean) != 0) return false;
		return true;
	}
	...
	public int hashCode() {
		final int PRIME = 31;
		int result = 1;
		final long temp1 = java.lang.Double.doubleToLongBits(this.mean);
		final long temp2 = java.lang.Double.doubleToLongBits(this.standardDeviation);
		final long temp3 = java.lang.Double.doubleToLongBits(this.variance);
		final long temp4 = java.lang.Double.doubleToLongBits(this.precision);
		final long temp5 = java.lang.Double.doubleToLongBits(this.precisionMean);
		result = result * PRIME + (int)(temp1 >>> 32 ^ temp1);
		result = result * PRIME + (int)(temp2 >>> 32 ^ temp2);
		result = result * PRIME + (int)(temp3 >>> 32 ^ temp3);
		result = result * PRIME + (int)(temp4 >>> 32 ^ temp4);
		result = result * PRIME + (int)(temp5 >>> 32 ^ temp5);
		return result;
	}
