...
public class PlayerPerformancesToTeamPerformancesLayer
		extends
		TrueSkillFactorGraphLayer<KeyedVariable<IPlayer, GaussianDistribution>, GaussianWeightedSumFactor, Variable<GaussianDistribution>> {
	public PlayerPerformancesToTeamPerformancesLayer(
	...
	protected GaussianWeightedSumFactor createPlayerToTeamSumFactor(
			List<KeyedVariable<IPlayer, GaussianDistribution>> teamMembers,
	...
	private Variable<GaussianDistribution> CreateOutputVariable(
		...
		return new Variable<GaussianDistribution>(
				GaussianDistribution.UNIFORM(), "Team[%s]'s performance",
				sb.toString());
	}
}