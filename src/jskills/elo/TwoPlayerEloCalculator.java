...
public abstract class TwoPlayerEloCalculator extends SkillCalculator {
	...
	public Map<IPlayer, Rating> calculateNewRatings(GameInfo gameInfo,
		...
		result.put(
				...
				calculateNewRating(gameInfo, player1Rating, player2Rating,
						isDraw ? PairwiseComparison.DRAW
	...
	protected EloRating calculateNewRating(GameInfo gameInfo,
		...
		double expectedProbability = getPlayerWinProbability(gameInfo,
	...
	protected abstract double getPlayerWinProbability(GameInfo gameInfo,
	...
	public double calculateMatchQuality(GameInfo gameInfo,
		...
		for (ITeam team : teams)
			players.add(team.keySet().toArray(new IPlayer[0])[0]);
		...
		double deltaFrom50Percent = Math.abs(getPlayerWinProbability(gameInfo,
